...
The controller I will be making in tandem shall link directly to my game. I plan to make the controller incorporate things like variable resistors, whereby the game will ask the player to set something to a certain value and they must set the potentiometers to that value. I will also be incorporating toggle switches to complete ‘activate’ and ‘Turn On’ commands. I have chosen toggle switches as I feel they make the controller feel more like it is part of a submarine command panel. I will also be trying to have red LEDs that light up when a certain switch or potentiometer needs using.
