...
// Sets default values
AArduinoControllerActor::AArduinoControllerActor()
{
	...
	ArduinoOutput = FString("JustBegan");
	ArduinoOutputInt = 0;
}

void AArduinoControllerActor::connect(wchar_t *portName) {
...
unsigned long int AArduinoControllerActor::ReadData(char *buffer, unsigned int nbChar)
{
...
void AArduinoControllerActor::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void AArduinoControllerActor::Tick(float DeltaTime)
{
...
bool AArduinoControllerActor::IsConnected()
{
